...
- safety-critical escalation path (chemical exposure from
  plate-processing solutions, imaging/platemaking equipment
  condition)
...
- a hard, unconditional block on any attempt to route a
  plate-preparation-execution decision, or a
  shop-safety-officer-override decision, through this actor — those
  decisions stay the shop safety officer's exclusive authority end to
  end
...
plate-preparation-execution decision or a shop-safety-officer
